        ...
        <form class="navbar-form navbar-right" role="search" action="${pageContext.request.contextPath}/FuzzyQueryServlet" method="post">
            <div class="form-group">
                            ...
                            <div class='input-group date' id='datetimepicker1'>
                                <input type='text' class="form-control" placeholder="请选择开始时间" name="startDate"/>
                          ...
                          <label>--</label>
                            ...
                            <div class='input-group date' id='datetimepicker2'>
                                <input type='text' class="form-control" placeholder="请选择结束时间" name="endDate"/>
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
            ...
            <div class="form-group">
                <input id="search" type="text" name="word" class="form-control" placeholder="请输入姓名">
            </div>
...
<div style="text-align: center;margin-top: 10px;">
    <div class="pager">
        ...
        <li><a href="${pageContext.request.contextPath}/PageServlet?pageNumber=1">首页</a></li>&nbsp;
        <c:if test="${pageBean.pageNumber gt 1}">
                <li><a href="${pageContext.request.contextPath}/PageServlet?pageNumber=${pageBean.pageNumber-1}">上一页</a></li>
 ...
 <!--       <a href="${pageContext.request.contextPath}/PageServlet?pageNumber=1">[首页]</a>|&nbsp;
        ...
        <c:forEach var="1" begin="1" end="${pageBean.totalPage}">
            ...
            <c:if test="${pageBean.pageNumber != i}">
                <a href="${pageContext.request.contextPath}/PageServlet?pageNumber=${i}">${i}</a>
            </c:if>
        </c:forEach>
         &nbsp;
        <c:if test="${pageBean.pageNumber lt pageBean.totalPage}">
                <li><a href="${pageContext.request.contextPath}/PageServlet?pageNumber=${pageBean.pageNumber+1}">下一页</a></li>&nbsp;
  ...
  <!--      <a href="${pageContext.request.contextPath}/PageServlet?pageNumber=${pageBean.pageNumber+1}">[下一页]</a>|&nbsp;
        ...
        <li><a href="${pageContext.request.contextPath}/PageServlet?pageNumber=${pageBean.totalPage}">尾页</a></li>
    </div>
</div>
<!-- 分页结束 -->
