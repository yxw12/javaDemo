...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminUpdatePro" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
	$(function(){
		//页面加载完毕后去异步获得分类数据
		$.post(
				"${pageContext.request.contextPath}/admin?method=adminCategory",
				function(data){
					//[{"cid":"xx","cname":"xxx"},{},{}]
