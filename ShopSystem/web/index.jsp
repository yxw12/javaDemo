	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${listHotPro}" var="hotpro">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${listNewPro}" var="newpro">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/product?method=productInformation&pid=${newpro.pid}">
							<img src="${pageContext.request.contextPath}/${newpro.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/product?method=productInformation" style='color:#666'>${newpro.pname}</a></p>
