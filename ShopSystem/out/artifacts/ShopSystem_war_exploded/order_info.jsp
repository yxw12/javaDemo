...
<body>
	...
	<div class="container">
			...
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						...
						<c:forEach items="${orders.orderItems}" var="itemO">
							<tr class="active">
								<td width="60" width="40%"><input type="hidden" name="id"
									value="22">
									<img src="${pageContext.request.contextPath}/${itemO.product.pimage}" width="70" height="60">
								</td>
								<td width="30%"><a target="_blank">${itemO.product.pname}</a></td>
								<td width="20%">￥${itemO.product.shop_price}</td>
								<td width="10%">${itemO.count}</td>
								<td width="15%"><span class="subtotal">￥${itemO.subtotal}</span></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div>
			<hr />
			<form id="orderFrom" class="form-horizontal" action="${pageContext.request.contextPath}/product" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="telephone" name="telephone"
								placeholder="请输入联系方式" ${user.telephone}>
						</div>
					</div>
				...
				<div style="margin-top: 5px;">
					...
					<p style="text-align: right; margin-right: 100px;">
						<a href="javascript:void(0);" onclick="confirmOrder1()">
