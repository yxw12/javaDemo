	...
	<div class="w" id="header-2013">
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<form id="actionForm" action="list3.action" method="POST">
				<div class="form">
				...
				<input type="hidden" name="page" id="page" value="${page.curPage }"/>
